...
# ------------------------------------------------------------------------------
# --------------- HELPER FUNCTIONS: SEARCH AND CONVERT -------------------------
# ------------------------------------------------------------------------------

# this method returns a string repr based on the unicode
# e.g. for u'\U0001F92D' this returns 1f92d.
# multiple chars are separated '-'
# it also adds the chars that are unnecessary in the png filename
def unicode_to_fullstring(unicode):
    unicode_repr = ""
    for char in unicode:
